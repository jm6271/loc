...
unsigned long LineCounter::CountLines(const std::filesystem::path& path, const std::string& inlineComment,
...
bool LineCounter::StrContains(const std::string& str, const std::string& substr)
{
