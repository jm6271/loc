...
std::string DirectoryScanner::to_lower_ascii(std::string_view s)
{
    std::string out;
    out.reserve(s.size());
...
std::string DirectoryScanner::normalize_ext(std::string_view ext, bool case_insensitive)
{
